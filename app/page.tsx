...
<a href="#about">About</a><a href="#experience">Experience</a><a href="#projects">Projects</a><a href="#certifications">Certifications</a><a className="route-link" href="/research">Research <span aria-hidden="true">↗</span></a><a href="#contact">Contact</a>
      ...
      <header id="top" className="hero wrap">
        <div className="hero-copy">
          ...
          <div className="hero-actions"><a className="button primary" href="#projects">View my work <span>↗</span></a><a className="button secondary" href="https://mail.google.com/mail/?view=cm&fs=1&to=fadydesoky45@gmail.com&su=Portfolio%20conversation" target="_blank" rel="noreferrer">Let&apos;s connect <span>↗</span></a></div>
        </div>
